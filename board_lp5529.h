...
/**@{*/ 
    ...
    #define BOARD_RED_LED_SELECTOR    BOARD_RED_LED_PORT , BOARD_RED_LED_PIN
    #define BOARD_GREEN_LED_SELECTOR  BOARD_GREEN_LED_PORT , BOARD_GREEN_LED_PIN
/**@}*/ 
